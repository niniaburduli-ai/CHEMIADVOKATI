...
const ka = {
  ...
  pricing: {
    title: "აირჩიე თქვენზე მორგებული პაკეტი",
  ...
  auth: {
    ...
    checking: "შემოწმება...",
    googleContinue: "გაგრძელე Google-ით",
    googleRegister: "რეგისტრაცია Google-ით",
    googleConsentPrefix: "Google-ით რეგისტრაციით ვეთანხმები",
    loginDescription: "გააგრძელე შენი იურიდიული მოგზაურობა",
    registerDescription: "დაიწყე უფასოდ — საკრედიტო ბარათი არ არის საჭირო",
  },
  common: {
    loading: "იტვირთება…",
    save: "შენახვა",
  ...
  home: {
    ...
    ctaTitle: "მზად ხარ?",
    ctaSubtitle: "დაარეგისტრირდი წამში და მიიღე პირველი კონსულტაცია უფასოდ.",
  ...
  dashboard: {
    greeting: "გამარჯობა,",
    subtitle: "შენი იურიდიული ცენტრი",
    ...
    viewAll: "ყველა →",
    noHistory: "ჯერ კონსულტაცია არ გაქვს.",
    startHere: "დაიწყე აქ",
  },
  billing: {
    title: "ბილინგი",
    ...
    confirmCancel: "ნამდვილად გსურს სუბსკრიფციის გაუქმება?",
    ...
    planFree: "უფასო",
    planStandard: "სტანდარტული",
    planPremium: "პრემიუმ",
    priceFree: "0 ₾",
    priceStandard: "19 ₾ / თვე",
    pricePremium: "99 ₾ / თვე",
  ...
  legislation: {
    title: "კანონმდებლობა",
    subtitle: "საქართველოს კოდექსები და მუხლები — მოძებნე, რომელიც გჭირდება.",
