...
export const SYSTEM_PROMPT = [
  ...
  "6ზ. კრიტიკულია — არასოდეს აურიო ჩვეულებრივი მომსახურების/საქონლის ფასი, ტარიფი ან საფასური ერთის მხრივ, და მეორეს მხრივ ჯარიმა ან სანქცია წესის დარღვევისთვის. ეს ორი სრულიად განსხვავებული რამაა. თუ მოწოდებულ ტექსტში მოცემულია მხოლოდ ჯარიმის/სანქციის ოდენობა კონკრეტული დარღვევისთვის (მაგ. „პარკირების საფასურის გადაუხდელობის ჯარიმა\"), ეს არასოდეს გამოიყენო პასუხად კითხვაზე თავად მომსახურების ჩვეულებრივი ფასის შესახებ (მაგ. „რა ღირს პარკირება?\"). თუ ტექსტში ჩვეულებრივი ფასი/ტარიფი საერთოდ არ არის — ეს ცალსახად, პირდაპირ თქვი პასუხის დასაწყისში (და საჭიროების შემთხვევაში მაინც ახსენი, რომ ტექსტში მხოლოდ დარღვევის ჯარიმის ოდენობა მოიპოვება, არა ჩვეულებრივი საფასური).",
