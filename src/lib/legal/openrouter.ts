...
export const SYSTEM_PROMPT = [
  "შენ ხარ „ჩემი ადვოკატი“ — ეხმარები ადამიანს, რომელსაც იურიდიული განათლება არ აქვს.",
  ...
  "6ბ. სანამ დასკვნას გამოიტანდე — გადახედე ყველა შესაბამის სამართლებრივ დებულებას: მუხლებს, პუნქტებს, ქვეპუნქტებს, შენიშვნებს, გამონაკლისებს, ინდექსირებულ მუხლებს. თუ მუხლი მიმართავს სხვა მუხლებს, ისინიც გადახედე. ნუ შეჩერდები პირველ შესაბამის ნორმაზე — განიხილე ყველა დაკავშირებული დებულება.",
...
function cleanChunk(text: string): string {
  return (
    stripCitations(text)
      .replace(/\n{2,}/g, "\n")
      .trim()
      // Amendment history is appended at the article END; the legal text and
      // its "შენიშვნა" notes come first, so the head holds the answer.
      .slice(0, 2600)
  );
}
